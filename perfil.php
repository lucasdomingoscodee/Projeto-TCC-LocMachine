...
// 2. Lógica para CANCELAR/EXCLUIR aluguel
if (isset($_GET['cancelar_id'])) {
    $id_aluguel = $_GET['cancelar_id'];
    
    // Deleta APENAS se o aluguel pertencer ao usuário logado (Segurança)
