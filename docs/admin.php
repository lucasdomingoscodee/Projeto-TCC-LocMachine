...
// 1. Lógica de Excluir Máquina
if (isset($_GET['deletar'])) {
    $id_del = $_GET['deletar'];
    $pdo->prepare("DELETE FROM maquinas WHERE id = ?")->execute([$id_del]);
    header("Location: admin.php"); // Recarrega para sumir
    exit;
}

// 2. Lógica de Adicionar Máquina (Mantida)
...
// 3. Adicionar Localidade (Mantida)
...
// Buscar todas as máquinas para a tabela
