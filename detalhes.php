...
// 3. Buscar Avaliações e Calcular Média
...
// Link do WhatsApp (Mensagem pronta)
$fone_empresa = "NUMERO DA EMPRESA AQUI"; // Coloque o número real aqui
