...
if (isset($_POST['finalizar']) && !empty($_SESSION['carrinho'])) {
    ...
    // Dados do formulário
    $datas_inicio = $_POST['inicio']; // Array [id_maquina => data]
    $datas_fim = $_POST['fim'];       // Array [id_maquina => data]
    ...
    foreach ($_SESSION['carrinho'] as $id_maq) {
        ...
        // Se o usuário não preencher data, usa hoje + 1 dia
        ...
        // Garante pelo menos 1 dia (se datas forem iguais ou invertidas)
    ...
    // Limpa carrinho e ativa mensagem de sucesso
    $_SESSION['carrinho'] = [];
    $msg_sucesso = true;
}
